package org.jboss.as.test.integration.naming.remote.multiclient;
...
public class JndiRmiTestCase {
    ...
    private URL urlTwo;
    private static final Package thisPackage = JndiRmiTestCase.class.getPackage();
    @Deployment(name="one")
    public static WebArchive deploymentOne() {
        return ShrinkWrap.create(WebArchive.class, "one.war")
        	...
        	.addAsManifestResource(thisPackage, "jboss-deployment-structure.xml", "jboss-deployment-structure.xml");
    }
    @Deployment(name="two")
    ...
    public static WebArchive deploymentThree() {
        return ShrinkWrap.create(WebArchive.class, "binder.war")
        	...
        	.setWebXML(JndiRmiTestCase.class.getPackage(), "web.xml");
    }
    @Test
